...
inquiry_options() {
  ...
  printf "\n\n"
  printf "   [0] Instalar ZapCheckin\n"
  printf "   [1] Atualizar ZapCheckin\n"
  printf "   [2] Deletar ZapCheckin\n"
  printf "   [3] Bloquear ZapCheckin\n"
  printf "   [4] Desbloquear ZapCheckin\n"
  printf "   [5] Alter. dominio do ZapCheckin\n"
  printf "\n"
  read -p "> " option
